...
namespace Trabalho_WhatsApp.Service
{
    class WhatsApp
    {
        ...
        public List<string> Retornar_Conversas()
        {
            ...
            {
                Thread.Sleep(TimeSpan.FromSeconds(1));
                System.Collections.ObjectModel.ReadOnlyCollection<AndroidElement> all_messages = driver.FindElementsByXPath("//android.widget.TextView[@resource-id='com.whatsapp:id/message_text']");
